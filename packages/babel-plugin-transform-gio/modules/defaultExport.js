...
const reassignDefaultExport = (t, exportPath, pragmaDefineExport, uniqueName, declaration) => {
...
const exportSpiedDefaultExport = (t, exportPath, pragmaDefineExport, uniqueName, exportName) => {
...
module.exports = function reassignAndReexportDefaultExport (t, exportPath, pragmaDefineExport) {
  ...
  reassignDefaultExport(t, exportPath, pragmaDefineExport, uniqueName, declaration)
